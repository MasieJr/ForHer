...
const memories: Memory[] = [
  ...
  },
  {
    id: 2,
    date: "13 June 2024",
    title: "Got a haircut ✂️",
    description:
      "She bullied me into getting a haircut for the first time in years. I hated it.",
    image: "images/2.jpg",
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    date: "29 June 2024",
    title: "The first image she sent me 📸",
    description:
      "She had done her makeup herself and was proud and excited to share it with me.",
    image: "images/4.jpg",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    title: "Reconnecting 📞",
    description:
      "Asked my mom to get me her number so I can show this stranger i had finally cut my hair. Was the first thing she wanted to see when she realized it was me.",
    image: "images/8.jpeg",
  },
  {
    id: 9,
  ...
  return (
    <div className="min-h-screen bg-pink-50 py-20 overflow-hidden">
      <motion.div
        ...
        style={{ scaleX }} // This connects the width to the scroll position
      />
      {/* Header */}
            ...
            >
              ...
              <div className="w-full md:w-5/12">
                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-pink-100 hover:shadow-2xl transition-shadow duration-300">
                  {/* Image Area */}
                  <div className="mb-4 overflow-hidden rounded-lg h-auto">
                    <img
                      src={item.image}
                      alt={item.title}
                      loading="lazy"
